...
void main_process_function(){
    ...
    while(1)
    {
        printf("Pass operation (ADD - 5, SUB - 6, MUL - 7, DIV - 8), then after space first and second val :\n");
        int how_much = scanf("%d %d %d", &operation, &val1, &val2);
        if (how_much != 3)
        {
